...
total_cost = float(input("\033[1;34;40m Enter the cost of your dream home: ​"))
semi_annual_raise = float(input("\033[1;34;40m Enter the semi­annual raise, as a decimal:​ "))
print("\033[1;31;40m >>>\n")
